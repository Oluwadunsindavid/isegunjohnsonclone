...
const About = () => {
  return (
    <div
      id="about"
      className="py-6 md:py-24 px-6 md:px-10 lg:px-16 xl:px-28 flex flex-col md:flex-row bg-[#f8f9fa]"
    >
      {/* Left/Top Hand Side - Image wrapper with overlay */}
      <motion.h2
        variants={fadeIn("up", 0.35)}
        initial="hidden"
        whileInView="show"
        viewport={{ once: false, amount: 0 }}
        className="relative rounded-2xl w-full group overflow-hidden"
      >
        <div>
          <img
            src={segun}
      ...
      <motion.h2
        ...
        whileInView="show"
        viewport={{ once: false, amount: 0 }}
        className="w-full md:pl-10 pt-6 md:pt-0"
      >
        <div>
          ...
          <p className="text-black leading-relaxed text-[1.1rem]">
            ...
            singing at 24 and launched his professional career as a crossover
            live band artist at 25.
          </p>
          <p className="text-gray-500 mt-2 text-[1.1rem]">
            International Sensation: Segun has sold out venues across
            continents, including London's Broadway Theatre,{" "}
